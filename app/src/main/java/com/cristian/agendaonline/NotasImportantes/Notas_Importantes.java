package com.cristian.agendaonline.NotasImportantes;
...
import com.cristian.agendaonline.Objetos.Nota;
import com.cristian.agendaonline.R;
import com.cristian.agendaonline.ViewHolder.ViewHolder_Nota_Importante;
...
public class Notas_Importantes extends AppCompatActivity {
    ...
    private void ComprobarUsuario(){
        if (user == null){
            Toast.makeText(com.cristian.agendaonline.NotasImportantes.Notas_Importantes.this, "Ha ocurrido un error", Toast.LENGTH_SHORT).show();
        }else {
