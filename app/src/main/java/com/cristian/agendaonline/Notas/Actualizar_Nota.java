package com.cristian.agendaonline.Notas;
...
public class Actualizar_Nota extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    Button Btn_Calendario_A, btnActulizar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnActulizar = findViewById(R.id.btnActualizar);
        ...
        btnActulizar.setOnClickListener(v ->{
            ActualizarNotaBD();
        });
    }
