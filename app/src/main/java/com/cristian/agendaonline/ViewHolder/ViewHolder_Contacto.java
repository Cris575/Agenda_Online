package com.cristian.agendaonline.ViewHolder;
...
import com.cristian.agendaonline.R;

public class ViewHolder_Contacto extends RecyclerView.ViewHolder {

    View mView;

    private ViewHolder_Contacto.ClickListener mClickListener;
    ...
    public void setOnClickListener(ViewHolder_Contacto.ClickListener clickListener){
        mClickListener = clickListener;
    }

    public ViewHolder_Contacto(@NonNull View itemView) {
        super(itemView);
        mView = itemView;
    ...
    public void SetearDatosContacto(Context context,String id_contacto, String uid_contacto, String nombres, String apellidos, String correo, String telefono, String direccion, String imagen){
        ImageView Imagen_c_Item;
        TextView Id_c_Item,Uid_c_Item, nombres_c_Item, apellidos_c_Item, correo_c_Item,telefono_c_Item,direccion_c_Item;
